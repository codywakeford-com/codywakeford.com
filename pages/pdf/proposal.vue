  ...
  <main v-if="proposal" class="quote">
    ...
    <article>
      <section>
        <h3>Overview</h3>
        <p>
          This document outlines my understanding of your project requirements
          to ensure we are aligned on the scope, objectives, and deliverables.
          It serves as a reference point to keep expectations clear and ensure a
      ...
      <section>
        ...
        <p>
          As part of my standard development process, your website will be fully
          mobile-responsive, rigorously tested, and optimized to ensure all
      ...
      <section>
        ...
        <p>
          ...
          {{ proposal.nDaysWork }} days. I will ensure the website is fully
          delivered and handed over by {{ proposal.due }}.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          To ensure a smooth workflow and mutual commitment throughout the
          project, payments will be structured in three stages:
        </p>
