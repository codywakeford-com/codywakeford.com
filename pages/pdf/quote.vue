  ...
  <main v-if="quote" class="quote">
    ...
    <article>
      ...
      <section class="garuntee">
        ...
        <p>
          I provide free bug fixes for 30 days after project completion to
          ensure everything runs smoothly.
        </p>
        <p>
          Before anything is released to the public all code is end-to-end
          tested using industry best practices, this ensures your website works
          seamlessly and without error on all devices.
        </p>
        <p>All my websites are 100% mobile responsive.</p>
        <p>
          All my clients get a google analytics hooked up to their website for
          free.
        </p>
        <p>
          Every website I build comes with an independent Google Lighthouse
          performance report as a testament to my commitment to quality.
        </p>
      </section>
    </article>
