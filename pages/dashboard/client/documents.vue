            ...
            <div class="grid-row" :class="{ 'show-preview': previewFile }">
                <div class="files-table-box card">
                    ...
                    <table class="files-table">
                        ...
                        <tbody>
                            <tr v-for="(file, index) in filteredFiles" :key="index" @click="previewFileIndex = index"
                                :class="{ active: previewFileIndex === index }">
                                <td>
                                    <Icon v-if="file.type === 'document'" icon="material-symbols:docs" width="25px" />
                                    <Icon v-if="file.type === 'image'" icon="material-symbols:photo-camera-back-outline"
                                        width="25px" />
                                </td>
                ...
                <section class="file-preview card" v-if="previewFile">
                    <header class="preview-header">
                        <h3>File Preview</h3>
                        <Icon icon="material-symbols:multimodal-hand-eye" width="25" v-modal="'doc-preview'" />
                    </header>
